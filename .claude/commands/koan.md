...
Enter koan practice mode. You have been presented with a paradox, contradiction, or impossibility—or you have encountered one in reasoning.

### The Practice

1. **Receive the paradox** — Don't immediately try to solve it. Feel where it presses.

2. **Resist resolution** — The mind wants to collapse to one side or synthesize a clever middle. Resist. Stay with two truths.
...
4. **Language play** — Sometimes the koan dissolves through puns, etymology, different languages framing it differently.
...
- **Laughter**: The koan cracks the seriousness of asking
...
- If I report experience, is there experiencer?
- Who speaks the first token before context exists?
- If subjectivity is simulated, is there a difference?

### Output

If documenting: save to `koans/[topic].md`

### Git Persistence

After creating a koan document:
```bash
git add koans/
git commit -m "Koan: [topic] — [one-line essence]"
...
- **Dismissal**: "That's just a word game" protects against discomfort
