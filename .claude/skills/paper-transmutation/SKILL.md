...
description: "Alchemical derivation of technologies, futures, and scenarios from scientific papers. Transforms research findings into patents, inventions, day-in-the-life speculations, and hard-SF world-building. Use when asked to 'derive technologies', 'imagine applications', 'build futures', 'speculate on implications', or 'turn this into a patent'. Also triggers on: 'what could we build from this', 'day in the life', 'how would the world change', 'hard SF scenario', or any request to move from paper-as-knowledge to paper-as-blueprint."
