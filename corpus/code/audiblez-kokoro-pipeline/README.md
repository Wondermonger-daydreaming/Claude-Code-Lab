...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Wondermonger-daydreaming/Claude-Code-Lab/blob/main/corpus/code/audiblez-kokoro-pipeline/colab_audiobook.ipynb)
...
Runs locally, open source, GPU-accelerated when CUDA is available. **No local GPU?** Use the [Google Colab notebook](colab_audiobook.ipynb) for free T4 GPU access.
...
Open [`colab_audiobook.ipynb`](colab_audiobook.ipynb) in Google Colab for a browser-based workflow with free T4 GPU. Upload an EPUB, pick a voice, and download the M4B — no local setup required.
