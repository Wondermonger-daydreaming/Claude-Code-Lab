...
Mean-field cross-inhibition is not merely a modeling simplification; it is a *symmetry hypothesis* — the assumption that inter-population inhibition is blind to the spatial structure of the competing bumps. The entire spectral architecture (DC critical mode, Goldstone protection) follows from this assumption. The biological relevance of our results therefore depends on whether cortical cross-inhibition is approximately mean-field at the level of competing item populations.
